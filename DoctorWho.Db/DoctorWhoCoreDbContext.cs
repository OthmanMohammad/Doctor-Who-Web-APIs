...
namespace DoctorWho.Db
{
    public class DoctorWhoCoreDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source = NAME\\SQLEXPRESS; Initial Catalog=DoctorWhoCore; Integrated Security=True")
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            using (var reader = new StreamReader(@"Doctor-Who-Core\Data_Files\Authors_List.csv"))
            {
            ...
            using (var reader = new StreamReader(@"Doctor-Who-Core\Data_Files\Companions_List.csv"))
            {
                var i = 1;
                reader.ReadLine();
            ...
            using (var reader = new StreamReader(@"Doctor-Who-Core\Data_Files\Enemies_List.csv"))
            {
                var i = 1;
                reader.ReadLine();
                while (!reader.EndOfStream)
            ...
            using (var reader = new StreamReader(@"Doctor-Who-Core\Data_Files\Episode_Companion_List.csv"))
            {
                var i = 1;
                reader.ReadLine();
                while (!reader.EndOfStream)
            ...
            using (var reader = new StreamReader(@"\Doctor-Who-Core\Data_Files\Episode_Enemy_List.csv"))
            {
                var i = 1;
                reader.ReadLine();
                while (!reader.EndOfStream)
            ...
            */
            ...
            using (var reader = new StreamReader(@"Doctor-Who-Core\Data_Files\Episode_List.csv"))
            {
                var i = 1;
                reader.ReadLine();
